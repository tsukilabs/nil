...
pub(crate) fn create() -> Router<App> {
  ...
  let router = Router::new()
    ...
    .route("/buy-resources", post(market::buy))
    ...
    .route("/cheat-fill-world", post(cheat::city::fill_world))
    ...
    .route("/cheat-get-cities", put(cheat::city::get_cities))
    .route("/cheat-get-city", put(cheat::city::get_city))
    ...
    .route("/get-armies", put(military::get_armies))
    ...
    .route("/sell-resources", post(market::sell))
    .route("/send-resources", post(market::send))
