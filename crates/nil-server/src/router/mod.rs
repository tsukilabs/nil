...
pub(crate) fn create() -> Router<App> {
  ...
  let router = Router::new()
    ...
    .route("/cheat/bot/{id}/resources", get(cheat::npc::get_bot_resources))
    ...
    .route("/cheat/precursor/{id}/resources", get(cheat::npc::get_precursor_resources))
    .route("/cheat/resources", get(cheat::resources::set_max_resources))
    .route("/cheat/resources", post(cheat::resources::set_resources))
