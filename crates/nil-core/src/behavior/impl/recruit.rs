...
use crate::infrastructure::building::r#impl::stable::recruit_queue::StableRecruitOrderRequest;
use crate::infrastructure::building::r#impl::workshop::recruit_queue::WorkshopRecruitOrderRequest;
