...
fn main() {
  ...
  builder
    ...
    .invoke_handler(tauri::generate_handler![
      ...
      command::cheat::resource::cheat_set_food,
      command::cheat::resource::cheat_set_iron,
      command::cheat::resource::cheat_set_max_food,
      command::cheat::resource::cheat_set_max_iron,
      command::cheat::resource::cheat_set_max_resources,
      command::cheat::resource::cheat_set_max_silo_resources,
      command::cheat::resource::cheat_set_max_stone,
      command::cheat::resource::cheat_set_max_warehouse_resources,
      command::cheat::resource::cheat_set_max_wood,
      command::cheat::resource::cheat_set_resources,
      command::cheat::resource::cheat_set_stone,
      command::cheat::resource::cheat_set_wood,
