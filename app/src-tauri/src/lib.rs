...
pub fn run() {
  builder()
    ...
    .invoke_handler(tauri::generate_handler![
      ...
      command::lua::execute_script,
      command::lua::execute_script_at,
      command::lua::import_script,
      command::lua::import_scripts,
      command::lua::is_script,
      command::lua::load_scripts,
      command::lua::script_dir,
