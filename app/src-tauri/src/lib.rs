...
pub fn run() {
  builder()
    ...
    .invoke_handler(tauri::generate_handler![
      ...
      command::capital::get_city_limit,
      command::chat::get_chat_history,
      command::chat::push_chat_message,
      command::cheat::behavior::cheat_get_build_steps,
      command::cheat::capital::cheat_get_influence,
      command::cheat::capital::cheat_set_influence,
      ...
      command::infrastructure::building::toggle_building,
