...
import { CopyIcon, DownloadIcon, PlayIcon, RefreshCwIcon, SaveIcon, Share2Icon } from 'lucide-vue-next';
import {
  Button,
  DropdownMenu,
  DropdownMenuContent,
...
<template>
  <div v-if="lg" class="flex items-center justify-end">
  ...
  <div v-else>
    <DropdownMenu>
      ...
      >
        <DropdownMenuGroup>
          <DropdownMenuItem
            :disabled="loading || isScriptDialogOpen || registry.length === 0"
